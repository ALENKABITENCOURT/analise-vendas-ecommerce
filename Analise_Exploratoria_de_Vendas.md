...
Para resolver essa questão e garantir uma análise de clientes completa, a tabela `online_retail_clean` foi recriada com um filtro adicional, considerando apenas transações com um `CustomerID` válido.
